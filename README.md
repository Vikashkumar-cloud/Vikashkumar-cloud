...
|--------|-------------|------------|
| [datavault-app](https://github.com/Vikashkumar-cloud/Data_vault-App) | Containerized Node.js application deployed with Kubernetes & GitHub Actions | Docker, Kubernetes, GitHub Actions, Node.js, mariadb, Linux |
